...
class FrameWindow(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.resizable(0, 0)
        PATH = os.path.abspath(os.curdir) + '\\icons\\logo.png'
        ...
        page_name = Createdb.__name__
        frame = Createdb(parent=container, controller=self)
...
class Createdb(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.dbImge = PhotoImage(file=dbimg)
        ...
        self.epsgImg = PhotoImage(file=epsgImg)
