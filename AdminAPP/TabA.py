...
class TAB_A(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        frmLab = LabelFrame(self, text="Tableau A des contenances", font=("Times New Roman", 14), bg="#F7F9F9")
    ...
    def generate(self):
        if self.idEnt.get() != '' and self.fv_box.get()!= '':
            ...
            if idval == True:
                ...
                showerror("TabA", "Id parcelle est invalide")
        else:
            showerror("TabA", "Veuillez remplir tous les champs ")
    ...
    def pdf(self):
        ...
        titr = str(self.polyg[0][11])
        numParcel = str(self.polyg[0][0])
        TabA_word_pdf.TabA.pdf(self, nomParcel, requis, titr, numParcel)
