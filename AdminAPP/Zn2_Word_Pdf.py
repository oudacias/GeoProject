...
# -- \\ INFORMATION BAS DE PAGE // --
        ...
        paragph5 = document.add_paragraph("N.B : Les carnets ZN2 doivent être établis sur calque stable ordinaire non végétal permettant leur conservation durable.")
        ...
        try:
            filename = 'P' + numParcel + '_ZN2.docx'
            filepath = os.path.join(os.path.join(os.path.expanduser('~')), 'Desktop\IFE_PIECES\ZN2', filename)

            if not os.path.exists(os.path.join(os.path.join(os.path.expanduser('~')), 'Desktop\IFE_PIECES\ZN2')):
                os.makedirs(os.path.join(os.path.join(os.path.expanduser('~')), 'Desktop\IFE_PIECES\ZN2'))


            document.save(filepath)


            msg = messagebox.showinfo("ZN2", "Fichier bien généré, Pouvez-vous l'ouvrire maintenant")
            Zn2File.Zn2File()

        except:
            msg = messagebox.showerror("ZN2", "Veuillez fermer le fichier")
...
# -- \\ INFORMATION BAS DE PAGE // --
        ...
        try:
            ...
            document.save(filepath)
            # PDF
            wordFile = 'P' + numParcel + '_ZN2.docx'
            pdfFile = 'P' + numParcel + '_ZN2.pdf'
            wdFormatPDF = 17
            in_file = os.path.join(os.path.join(os.path.expanduser('~')), 'Desktop\IFE_PIECES\ZN2', wordFile)
            out_file = os.path.join(os.path.join(os.path.expanduser('~')), 'Desktop\IFE_PIECES\ZN2', pdfFile)
            if not os.path.exists(os.path.join(os.path.join(os.path.expanduser('~')), 'Desktop\IFE_PIECES\ZN2')):
                os.makedirs(os.path.join(os.path.join(os.path.expanduser('~')), 'Desktop\IFE_PIECES\ZN2'))
