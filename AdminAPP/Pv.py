...
class Pv(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        frmLab = LabelFrame(self, text="PV", font=("Times New Roman", 14), bg="#F7F9F9")
    ...
    def generate(self):
        if self.idEnt.get() != '' and self.fv_box.get() != '':
            ...
            if idval == True:
                ...
                showerror("PV", "Id parcelle est invalide")
        else:
            showerror("PV", "Veuillez remplir tous les champs ")
    def word(self):
    ...
    def pdf(self):
        numParcel = str(self.polyg[0][0])
        PV_word_pdf.PV.pdf(self, numParcel)
