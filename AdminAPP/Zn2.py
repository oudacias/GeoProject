...
class Zn2(tk.Tk):
    ...
    def generate(self):
        if self.idEnt.get() != '' and self.fv_box.get()!= '':
            ...
            if idval == True:
                ...
                showerror("ZN2", "Id parcelle est invalide")
        else:
            showerror("ZN2", "Veuillez remplir tous les champs ")
    ...
    def pdf(self):
        ...
        sol1 = str(self.tpSol[0][1])
        surf27 = str(self.polyg[5])
        Zn2_Word_Pdf.ZN2.word_to_pdf(self, person1, person3, mrch1, sz, mrch0, mrch2, person5, person7, person8, dr, polyg0, polyg1, oppos1, consis1, specul1, sol1, surf27)
